...
class WaypointUpdater(object):
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        temp = []
        stop_idx = max(self.stopline_wp_idx - closest_idx - 2, 0)  # two waypoints behind the line so that the front of the car stops at the line
    ...
    def traffic_cb(self, msg):
        ...
        if verbose:
            rospy.logerr("Traffic light data received: stopline waypoint index = " + str(self.stopline_wp_idx))
